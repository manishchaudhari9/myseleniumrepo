...
public class AppKeywords extends GenericKeywords {
	...
	public void deleteStock() {
		...
		driver.findElement(
				By.xpath("//table[@id='stock']/tbody/tr[" + rNum + "]/td[1]"))
				.click();
		driver.findElements(By.xpath("//input[@name='Delete']")).get(rNum - 1)
				.click();
	...
	public void buySellStock() {
		...
		driver.findElement(
				By.xpath("//table[@id='stock']/tbody/tr[" + rNum + "]/td[1]"))
				.click();
		driver.findElements(By.xpath("//input[@class='buySell']"))
				.get(rNum - 1).click();
		test.log(Status.INFO, "Performing action - " + data.get("Action"));
		click("buySellCalendar_id");
		new Select(getObject("actionBuySell_id")).selectByVisibleText(data
				.get("Action"));
		selectDate(data.get("Date"));
	...
	public void checkHistory() {
		...
		driver.findElement(
				By.xpath("//table[@id='stock']/tbody/tr[" + rNum + "]/td[1]"))
				.click();
		driver.findElements(By.xpath("//input[@class='equityTransaction']"))
				.get(rNum - 1).click();
		String actual = driver.findElement(
				By.xpath("//table[@id='stock']/tbody/tr[" + rNum + "]/td[5]"))
				.getText();
		List<WebElement> shares = driver.findElements(By.xpath(prop
				.getProperty("shares_xpath")));
		List<WebElement> prices = driver.findElements(By.xpath(prop
				.getProperty("prices_xpath")));
		...
		double average = Double.valueOf(totalAmount)
				/ Double.valueOf(totalShares);
	...
	public void selectDate(String d) {
		...
		try {
			...
			while (true) {
				String displayedMonthYear = driver.findElement(
						By.cssSelector(".dpTitleText")).getText();
